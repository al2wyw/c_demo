 ...
 *  r; c; finish(fi); return; util; si; ni; jump; p/x ptr; p * ptr; set x=1; set {int}0x7fffffffe31c=13; display $rsp; ptype /m; info local/arg/reg/fun/addr/b xxxx; handle SIGSEGV nostop
