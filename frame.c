 ...
 * gdb: b main; b main.c:10; b *addr; r; si; ni; x/nfu $rbp-4 f=o,x,u,s,i(str,inst) u=b,h,w,g; disass main; disass /r 0x8048000, 0x8048000+200; layout asm; ctl+c then a; focus cmd; display $rsp; info reg/fun/addr xxxx
