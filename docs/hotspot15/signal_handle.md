...
flowchart TB
    ...
    subgraph 同步异常路径
      C -- SIGSEGV/SIGBUS/SIGFPE/SIGILL --> D[JVM_handle_linux_signal<br/>本线程上下文处理<br/>隐式NPE/SafepointPoll/JIT trap]
    end

    subgraph 内置异步路径
      C -- SIGQUIT/BREAK_SIGNAL --> E[UserHandler<br/>signal_notify SIGQUIT]
