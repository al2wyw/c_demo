...
sh ./configure --with-debug-level=slowdebug  --enable-ccache OBJCOPY=objcopy --with-boot-jdk=/root/jdk1.7.0_80   --enable-debug-symbols --with-jvm-variants=zero
CONFIG_RET=$?
